...
* Define a custom content model
    ...
    To get you started, you can use the example model that is provided with the [Smart Folders tutorial]({% link content-services/7.2/tutorial/smart.md %}) for more information. See [Content modeling with Model Manager]({% link content-services/community/config/models.md %}) for more information on content models.
