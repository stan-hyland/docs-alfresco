...
Use the Smart Folder tutorial, [Smart Folders tutorial]({% link content-services/7.2/tutorial/smart.md %}), to set up a working Smart Folder configuration. General configuration information is here: [Configure Smart Folders]({% link content-services/community/config/index.md %}).
