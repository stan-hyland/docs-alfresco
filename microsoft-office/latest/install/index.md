...
1. Install the AMP file `alfresco-aos-module-1.4.x.amp`. See [Installing an AMP]({% link content-services/7.2/install/zip/amp.md %}) for information about installing an AMP file.
