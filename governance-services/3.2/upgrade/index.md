...
Check the [Supported Platforms]({% link content-services/7.2/support/index.md %}) and the [Alfresco Content Services upgrade paths]({% link content-services/7.2/upgrade/index.md %}).
