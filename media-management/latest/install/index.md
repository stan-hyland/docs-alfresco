...
2. Use the topic, [Uninstall an AMP file]({% link content-services/7.2/install/zip/amp.md %}), to uninstall the module.

3. If you have used a Media Management content model like IPTC or PBCore, you must clean out your database before restarting Alfresco. See [Dynamic deployment approach]({% link content-services/7.2/develop/repo-ext-points/content-model.md %}#dynamic-deployment-approach) for more information.
