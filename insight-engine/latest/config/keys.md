...
4. Override the SSL properties as shown.
    ...
    See [Installing the Tomcat application server]({% link content-services/7.2/install/zip/tomcat.md %}) and [Solr configuration files]({% link insight-engine/latest/config/index.md %}#solr-configuration-files) for more.
