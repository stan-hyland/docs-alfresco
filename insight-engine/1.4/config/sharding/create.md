...
* Support for shard groups requires a clustered license. Make sure that you enable clustering on your Alfresco Content Services license. For more information, see [Install and configure Content Services nodes]({% link content-services/7.2/admin/cluster.md %}#install-and-configure-content-services-nodes) and [Uploading a new license]({% link content-services/7.2/admin/license.md %}#uploadlicense).
